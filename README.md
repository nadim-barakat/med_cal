...
5. Don't hit run right away. We have to make few edits to:
   5a. In Google Calendar, click on your calendar from Oasis. Hit the three icons that take you to settings. Scroll down until you find calendar id. Copy that. 
<img width="625" alt="Screenshot 2024-07-30 at 8 24 27 PM" src="https://github.com/user-attachments/assets/9736d9b2-1c2b-4391-b5d2-1b1887b1a007">
   5b. paste that calendar id into the quotes in the code next to "sourceCalendarId." It should something like 
<img width="709" alt="Screenshot 2024-07-30 at 8 26 39 PM" src="https://github.com/user-attachments/assets/3d2f93e2-1d34-4d42-a7c3-582b8158e502">
   5c. Do the same for your target calendar id. This is the calendar that you created in step 2 of this tutorial. Paste the id into the quotes next to targetCalendarId.
   5d. Now scroll down and change myPopGroup variable. Change this to your group's number. I happen to be group 7. 
<img width="442" alt="Screenshot 2024-07-30 at 8 28 44 PM" src="https://github.com/user-attachments/assets/4f6d124b-54a2-4f32-bfe0-c693178cc665">
   5e. Change your team letter. I happen to be letter B.  
...
6.
   6a. Click the save icon on the toolbar.
   6b. make sure SyncCalendar is the function selected in the dropdown
  ...
  6c. Click run. It might say you need permission. I can't recreate this on my computer since I already gave it permission. But you might need to hit "Advanced" and then "continute anways" or something along those lines.
  6d. It takes about 3-4 mins (my code isn't efficient) to run so just leave it until after it stops loading. 
8. Deselect your old calendar on Google Cal and enjoy your new one!
